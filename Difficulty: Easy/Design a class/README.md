<h2><a href="https://www.geeksforgeeks.org/problems/design-a-class/1?page=1&category=CPP&difficulty=Easy&status=unsolved&sortBy=submissions">Design a class</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Design a class as described below.</span></p>
<blockquote>
